...
RNALigVS is a physics-guided RNA-focused virtual screening framework developed for predicting RNA–ligand interaction probability using structural and physicochemical interaction descriptors.
